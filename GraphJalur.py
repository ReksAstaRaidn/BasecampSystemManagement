...
class Graph:
    ...
    def visualisasi_jalur(self):
        ...
        try:
            ...
            # 1. Gambar empat arah panah (Utara diberi warna merah sebagai penanda utama)
            ...
            # 2. Tambahkan label huruf di ujung luar panah agar tidak menumpuk
            ...
            # 3. Titik pusat lingkaran kecil kompas
